...
type ChartTooltipContentProps = React.ComponentProps<"div"> & {
  // Tooltip "content" renderer props from Recharts (typed loosely for cross-version compatibility)
  active?: boolean;
  payload?: ChartTooltipPayloadItem[];
  label?: unknown;

  // Recharts optional render helpers (typed loosely to avoid version mismatch)
  formatter?: (
    value: unknown,
    name: string | number,
  ...
  // Custom props used by this component
  hideLabel?: boolean;
...
const ChartTooltipContent = React.forwardRef<HTMLDivElement, ChartTooltipContentProps>(
  (
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      return <div className={cn("font-medium", labelClassName)}>{value as any}</div>;
...
function getPayloadConfigFromPayload(config: ChartConfig, payload: unknown, key: string) {
  ...
  const payloadPayload =
    "payload" in p && typeof p.payload === "object" && p.payload !== null ? (p.payload as Record<string, unknown>) : undefined;
